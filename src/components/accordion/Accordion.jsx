  ...
  return (
    <div className={classes.root}>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            <div className={s.typographyWrap}>
              <CheckboxLabels title={'В наличие'} />
              <CheckboxLabels title={'Под заказ'} />
            </div>
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography className={s.typography}>
            <div className={s.typographyWrap}>
              <CheckboxLabels title={'Все'} />
              <CheckboxLabels title={'Новинки'} />
              <CheckboxLabels title={'Акции'} />
            </div>
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}>Модель</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}>Страны</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
